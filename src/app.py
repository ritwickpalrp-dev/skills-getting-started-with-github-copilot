...
activities = {
    ...
    "Basketball Team": {
        "description": "Competitive team practices and inter-school matches",
    ...
    "Debate Team": {
        "description": "Formal debate training and tournament preparation",
    ...
    "Math Olympiad": {
        ...
        "schedule": "Wednesdays, Saturdays, 4:00 PM - 6:00 PM",
        "max_participants": 16,
